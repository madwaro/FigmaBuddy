...
**Important:** When writing to `./tmp`, prefer using terminal commands (e.g., writing via Python or shell scripts) rather than file-editing tools, to avoid triggering unnecessary diff review prompts.
